...
export default {
  ...
  formFieldLabel__emailAddress_phoneNumber_username:
    "عنوان البريد الإلكتروني أو رقم الهاتف أو اسم المستخدم",
  ...
  formFieldError__verificationLinkExpired:
    "انتهت صلاحية رابط التحقق. الرجاء طلب رابط جديد.",
  ...
  signIn: {
    ...
    resetPassword: {
      ...
      successMessage:
        "تم تغيير كلمة السر بنجاح. جاري تسجيل دخولك، من فضلك انتظر لحظة.",
      requiredMessage:
  ...
  unstable__errors: {
    ...
    form_param_format_invalid__email_address:
      "يجب أن يكون عنوان البريد الإلكتروني عنوان بريد إلكتروني صالحًا.",
    form_password_validation_failed: "كلمة سر خاطئة",
    form_password_not_strong_enough:
      "كلمة المرور الخاصة بك ليست قوية بما فيه الكفاية.",
    ...
    zxcvbn: {
      ...
      couldBeStronger:
        "كلمة المرور الخاصة بك تعمل، ولكن يمكن أن تكون أقوى. حاول إضافة المزيد من الأحرف.",
      ...
      warnings: {
        ...
        pwned:
          "تم الكشف عن كلمة المرور الخاصة بك عن طريق خرق البيانات على الإنترنت.",
      },
      suggestions: {
        ...
        longerKeyboardPattern:
          "استخدم أنماط لوحة المفاتيح الأطول وقم بتغيير اتجاه الكتابة عدة مرات.",
    ...
    form_param_max_length_exceeded__last_name:
      "يجب ألا يتجاوز الاسم الأخير 256 حرفًا.",
  },
  userProfile: {
    ...
    start: {
      ...
      emailAddressesSection: {
        ...
        detailsSubtitle__primary:
          "عنوان البريد الإلكتروني هذا هو عنوان البريد الإلكتروني الأساسي",
        ...
        detailsSubtitle__unverified:
          "أكمل التحقق للوصول إلى جميع الميزات باستخدام عنوان البريد الإلكتروني هذا",
        detailsAction__unverified: "التحقق من عنوان البريد الإلكتروني",
        destructiveActionTitle: "حذف",
        destructiveActionSubtitle:
          "احذف عنوان البريد الإلكتروني هذا وقم بإزالته من حسابك",
    ...
    profilePage: {
      ...
      fileDropAreaHint:
        "قم بتحميل صورة JPG أو PNG أو GIF أو WEBP بحجم أصغر من 10 ميغابايت",
      readonly:
        "لقد تم توفير معلومات ملف التعريف الخاص بك عن طريق اتصال المؤسسة ولا يمكن تحريرها.",
    ...
    emailAddressPage: {
      ...
      emailCode: {
        formHint:
          "سيتم إرسال بريد إلكتروني يحتوي على رمز التحقق إلى عنوان البريد الإلكتروني هذا.",
        formTitle: "رمز التحقق",
      ...
      emailLink: {
        formHint:
          "سيتم إرسال بريد إلكتروني يحتوي على رابط التحقق إلى عنوان البريد الإلكتروني هذا.",
        formTitle: "رابط التحقق",
        formSubtitle:
          "انقر على رابط التحقق في البريد الإلكتروني المرسل إلى {{identifier}}",
        resendButton: "لم تتلق الرابط؟ إعادة إرسال",
        successMessage: "تمت إضافة البريد الإلكتروني {{identifier}} إلى حسابك.",
      },
      removeResource: {
        ...
        messageLine2:
          "لن تتمكن بعد الآن من تسجيل الدخول باستخدام عنوان البريد الإلكتروني هذا.",
    ...
    passwordPage: {
      ...
      readonly:
        "لا يمكن تعديل كلمة المرور الخاصة بك حاليًا لأنه لا يمكنك تسجيل الدخول إلا عبر اتصال",
